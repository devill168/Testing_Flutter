...
Edit the ‘layout’ file and change the code below (Line 4) with the filename of the background image containing the device color you’ve chosen (same with foreground):
